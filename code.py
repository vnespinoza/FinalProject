...
# 2. Identify and count bigrams within each group.
	...
	allbigrams = bigrams + morebigrams
...
#both_said_english = 0 #TP
#we_said_english = 0 #TP+FP
#data_said_english = 0 #TP +FN
tp = 0
fn = 0
fp = 0
tn = 0
...
for line in test_file:
	...
	all_input_bigrams = input_bigrams + more_input_bigrams
